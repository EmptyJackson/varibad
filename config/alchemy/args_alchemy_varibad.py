...
def get_args(rest_args):
    ...
    parser.add_argument('--num_frames', type=int, default=1e9, help='number of frames to train')
    ...
    parser.add_argument('--policy_num_steps', type=int, default=40,
    ...
    parser.add_argument('--wandb_group', default='alchemy_varibad', help='wandb group')
